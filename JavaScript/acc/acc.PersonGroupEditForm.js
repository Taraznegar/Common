(function () {
    var FormClass = afw.EntityWindowBase.extend({
        GetType: function () {
            return acc.PersonGroupEditForm;
        },
        ...
        init: function (options) {
            ...
            that._PersonGroupID = that._BindableEntity.get("ID");
            ...
            that._PersonGroupAccountsGridView = new afw.GridView({
            ...
            that._PersonGroupAccounts = afw.uiApi.CallServerMethodSync("cmn.GetPersonGroupAccounts", [that._PersonGroupID, that._FinancialYearID]);
        ...
        _AddButton_Click: function (e) {
            ...
            if (that._TitleFieldControl.GetValue() != null) {
                if (!ValueIsEmpty(that._TitleFieldControl.GetValue().trim())) {
                    ...
                    if (that._NodeItemID != null && that._PersonGroupID != null)
                        afw.uiApi.CallServerMethodSync("cmn.SevePersonGroupAccounts", [that._NodeItemID, that._PersonGroupID, that._FinancialYearID]);
        ...
        _DelButton_Click: function (e) {
            ...
            var selectedEntities = that._PersonGroupAccountsGridView.GetSelectedRows();
            if (selectedEntities == 0) {
                ...
                if (accountItemID != null && that._PersonGroupID != null)
                    afw.uiApi.CallServerMethodSync("cmn.DeletePersonGroupAccount", [accountItemID, that._PersonGroupID]);
        ...
        _SortItems: function () {
            ...
            that._PersonGroupAccounts.Entities = that._PersonGroupAccounts.Entities.sort(
        ...
        _FillGrid: function () {
            ...
            that._PersonGroupAccountsGridView.GetDataSource().data(that._PersonGroupAccounts.ToDataSourceData());

            //that._PersonGroupAccountsGridView.GetDataSource().data(
            //    $.grep(that._PersonGroupAccounts.ToDataSourceData(),
            //        function (o) { return o._Entity.GetFieldValue("ID") == that._MaleLockerComboBox.GetValue(); })
            //    );
            //that._PersonGroupAccountsGridView.SelectRowByIndex(that._PersonGroupAccounts.Entities.length - 1); 
        },
    ...
    FormClass.TypeName = "acc.PersonGroupEditForm";
    FormClass.BaseType = afw.EntityWindowBase;


    acc.PersonGroupEditForm = FormClass;
})();