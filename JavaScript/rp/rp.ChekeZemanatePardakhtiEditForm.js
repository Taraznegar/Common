(function () {
    var FormClass = afw.BasePanel.extend({
        GetType: function () {
            return rp.ChekeZemanatePardakhtiEditForm;
        },
        ...
        init: function (options) {
            ...
            that._BankAccountFieldControl_DropDownList = that._BankAccountFieldControl.FindControl("InnerControl").GetDropDownList();
            ...
            that._SharheChekeZemanatTextBox = that.FindControl("SharheChekeZemanatTextBox");
        ...
        _SetCreditorAccountLookupControlValue: function () {
            ...
            if (bankAccount.length != 0) {
                ...
                if (!ValueIsEmpty(bankAccountAccSetting)) {
                    if (!ValueIsEmpty(bankAccountAccSetting.GetFieldValue("HesabeCheqeZemanat")))
                        that._ParentEntity.set("CreditorAccount", bankAccountAccSetting.GetFieldValue("HesabeCheqeZemanat"));
                    else {
                        afw.ErrorDialog.Show("حساب چک ضمانت در حساب بانکی تعیین نشده است");
        ...
        _RefreshDescription: function () {
            ...
            var desc = String.Format("چک ضمانت پرداختی، دریافت کننده {0}، تاریخ چک {1}، حساب بانکی {2}، مبلغ {3}",
                                     payeeName, dueDate, bankAccountNumber, amount);

            that._SharheChekeZemanatTextBox.SetValue(desc);
        },
        ...
        SetFocus: function () {
            ...
            if (that._PayeeFieldControl.GetValue() == null)
                ...
                that._BankAccountFieldControl_DropDownList.Focus();
        },
    ...
    FormClass.TypeName = "rp.ChekeZemanatePardakhtiEditForm";
    FormClass.BaseType = afw.BasePanel;


    rp.ChekeZemanatePardakhtiEditForm = FormClass;
})();