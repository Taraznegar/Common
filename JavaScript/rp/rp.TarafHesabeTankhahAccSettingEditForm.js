(function () {
    ...
    var FormClass = afw.EntityWindowBase.extend({
        ...
        GetType: function () {
            return rp.TarafHesabeTankhahAccSettingEditForm;
        },
    ...
    FormClass.TypeName = "rp.TarafHesabeTankhahAccSettingEditForm";
    FormClass.BaseType = afw.EntityWindowBase;
    FormClass.Events = objectEvents;

    rp.TarafHesabeTankhahAccSettingEditForm = FormClass;
})();
