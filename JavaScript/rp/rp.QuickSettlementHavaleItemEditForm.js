(function () {
    ...
    var FormClass = afw.EntityWindowBase.extend({
        ...
        GetType: function () {
            return rp.QuickSettlementHavaleItemEditForm;
        },
        ...
        init: function (options) {
            ...
            that._FinancialOpKindLookupControl.SetBaseFilterExpression(
                String.Format("ReceiveOrPay = '{0}' and ReceiveDocType in (select ID from rp_ReceiveTypes where Name = 'Havale') and IsActive = 1",
    ...
    FormClass.TypeName = "rp.QuickSettlementHavaleItemEditForm";
    FormClass.BaseType = afw.EntityWindowBase;
    FormClass.Events = objectEvents;

    rp.QuickSettlementHavaleItemEditForm = FormClass;
})();
