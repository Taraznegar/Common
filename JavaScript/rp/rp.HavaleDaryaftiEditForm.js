(function () {
    var FormClass = afw.BasePanel.extend({
        GetType: function () {
            return rp.HavaleDaryaftiEditForm;
        },
        ...
        _RefreshDescription: function () {
            ...
            var desc = String.Format("طی حواله {0} ، از {1}، واریز به {2} ، به مبلغ {3} ",
                                    shomareHavale, payerName, bankAccountNumber, amount);
    ...
    FormClass.TypeName = "rp.HavaleDaryaftiEditForm";
    FormClass.BaseType = afw.BasePanel;


    rp.HavaleDaryaftiEditForm = FormClass;
})();