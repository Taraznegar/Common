(function () {
    ...
    var FormClass = afw.EntityWindowBase.extend({
        ...
        GetType: function () {
            return rp.QuickSettlementPosItemEditForm;
        },
        ...
        init: function (options) {
            ...
            that._FinancialOpKindLookupControl.SetBaseFilterExpression(
                String.Format("ReceiveOrPay = '{0}' and ReceiveDocType in (select ID from rp_ReceiveTypes where Name = 'Pos') and IsActive = 1",
    ...
    FormClass.TypeName = "rp.QuickSettlementPosItemEditForm";
    FormClass.BaseType = afw.EntityWindowBase;
    FormClass.Events = objectEvents;

    rp.QuickSettlementPosItemEditForm = FormClass;
})();