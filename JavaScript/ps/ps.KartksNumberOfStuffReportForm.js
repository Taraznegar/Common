(function () {
    var FormClass = afw.BasePanel.extend({
        GetType: function () {
            return ps.KartksNumberOfStuffReportForm;
        },
            ...
            if (that._FromStuffLookupControl.GetValue() != null)
                if (that._FromDateTimeControl.GetValue() != null)
                    if (that._ToDateTimeControl.GetValue() != null) {
                        ...
                        afw.ReportHelper.RunReport("ps.KartksNumberOfStuff",
        ...
        _CreateGridView: function () {
            ...
            var customer = { title: "مشتری", field: "Customer", rightToLeft: true, width: 40 };
            ...
            var columns = [invoiceDate, kind, invoiceNumber, customer, description, enter, exportStuff, remaining];
            ...
            var entityList = afw.uiApi.CallServerMethodSync("ps.GetKartksNumberOfStuffData", [that._FromDateTimeControl.GetValue(), that._ToDateTimeControl.GetValue(), that._FromStuffLookupControl.GetValue(), that._PersonLookupControl.GetValue()]);
    ...
    FormClass.TypeName = "ps.KartksNumberOfStuffReportForm";
    FormClass.BaseType = afw.BasePanel;


    ps.KartksNumberOfStuffReportForm = FormClass;
})();