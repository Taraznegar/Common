(function () {
    var FormClass = afw.BasePanel.extend({
        GetType: function () {
            return ps.ReturnFromBuyItemsGridRowControl;
        },
        ...
        _CalculateTaxAndToll: function () {
            ...
            if (ValueIsEmpty(that._GridControl.GetReturnFromBuyEditForm().GetBindableEntity().get("FinancialDocType"))) {
        ...
        _HasTaxAndToll: function () {
            ...
            var taxCalculationIsEnabled = that._GridControl.GetReturnFromBuyEditForm().GetTaxCalculationIsEnabled();
    ...
    FormClass.TypeName = "ps.ReturnFromBuyItemsGridRowControl";
    FormClass.BaseType = afw.BasePanel;


    ps.ReturnFromBuyItemsGridRowControl = FormClass;
})();