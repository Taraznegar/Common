(function () {
    var FormClass = afw.BasePanel.extend({
        GetType: function () {
            return ps.ReturnFromSaleItemsGridControl;
        },
        ...
        init: function (options) {
            ...
            that._ReturnFromSalesEditForm = options.ReturnFromSalesEditForm;
            that._RowsEntityList = that._ReturnFromSalesEditForm.ItemsEntityList;
        ...
        GetReturnFromSalesEditForm: function () {
            var that = this;

            return that._ReturnFromSalesEditForm;
        },
        ...
        AddRow: function (rowEntity) {
            ...
            var rowControl = new ps.ReturnFromSaleItemsGridRowControl({
        ...
        AddEmptyItems: function (itemsCount) {
            ...
            for (var i = 0; i < itemsCount; i++) {
                itemEntity = afw.uiApi.CreateNewEntity("ps.ReturnFromSaleItem");
                itemEntity.SetFieldValue("ReturnFromSale", that._ReturnFromSalesEditForm.GetBindableEntity().get("ID"));
        ...
        UpdateSummaryLabels: function () {
            ...
            that._ReturnFromSalesEditForm.UpdateSummaryFields();
        },
    ...
    FormClass.TypeName = "ps.ReturnFromSaleItemsGridControl";
    FormClass.BaseType = afw.BasePanel;


    ps.ReturnFromSaleItemsGridControl = FormClass;
})();