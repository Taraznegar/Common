(function () {
    ...
    var FormClass = afw.BasePanel.extend({
        ...
        GetType: function () {
            return wm.RialiNemodanAsnadAnbarForm;
        },
        ...
        _CreateDataList: function () {
            ...
            that._DataListControl = afw.uiApi.CreateDataListControl("wm.RialiNemodanAsnadAnbarList", {
    ...
    FormClass.TypeName = "wm.RialiNemodanAsnadAnbarForm";
    FormClass.BaseType = afw.BasePanel;
    FormClass.Events = objectEvents;

    wm.RialiNemodanAsnadAnbarForm = FormClass;
})();