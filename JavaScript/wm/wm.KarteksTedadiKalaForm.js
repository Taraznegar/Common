(function () {
    var FormClass = afw.BasePanel.extend({
        GetType: function () {
            return wm.KarteksTedadiKalaForm;
        },
            ...
            if (that._FromStuffLookupControl.GetValue() != null)
                if (that._FromDateTimeControl.GetValue() != null)
                    if (that._ToDateTimeControl.GetValue() != null) {
                        ...
                        afw.ReportHelper.RunReport("wm.KarteksTedadiKala",
        ...
        _CreateGridView: function () {
            ...
            var columns = [ghabzOrHavaleDate, kind, ghabzOrHavaleNumber, customer, enter, exportStuff, remaining];
            ...
            var entityList = afw.uiApi.CallServerMethodSync("wm.GetKarteksTedadiData",
    ...
    FormClass.TypeName = "wm.KarteksTedadiKalaForm";
    FormClass.BaseType = afw.BasePanel;


    wm.KarteksTedadiKalaForm = FormClass;
})();