(function () {
    var FormClass = afw.BasePanel.extend({
        GetType: function () {
            return wm.WarehouseHybridOperationItemsGridControl;
        },
        ...
        init: function (options) {
            ...
            that.WarehouseHybridOperationEditForm = options.WarehouseHybridOperationEditForm;
            that.RowsEntityList = that.WarehouseHybridOperationEditForm.ItemsEntityList;
        ...
        AddEmptyItems: function (itemsCount) {
            ...
            for (var i = 0; i < itemsCount; i++) {
                itemEntity = afw.uiApi.CreateNewEntity("wm.WarehouseHybridOperationItem");
                itemEntity.SetFieldValue("WarehouseHybridOperation",
                    that.WarehouseHybridOperationEditForm.GetBindableEntity().get("ID"));
        ...
        AddRow: function (rowEntity) {
            ...
            var rowControl = new wm.WarehouseHybridOperationItemsGridRowControl({
    ...
    FormClass.TypeName = "wm.WarehouseHybridOperationItemsGridControl";
    FormClass.BaseType = afw.BasePanel;


    wm.WarehouseHybridOperationItemsGridControl = FormClass;
})();