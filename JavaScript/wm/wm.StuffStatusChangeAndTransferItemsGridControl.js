(function () {
    var FormClass = afw.BasePanel.extend({
        GetType: function () {
            return wm.StuffStatusChangeAndTransferItemsGridControl;
        },
        ...
        init: function (options) {
            ...
            that.StuffStatusChangeAndTransferEditForm = options.StuffStatusChangeAndTransferEditForm;
            that.RowsEntityList = that.StuffStatusChangeAndTransferEditForm.ItemsEntityList;
        ...
        AddEmptyItems: function (itemsCount) {
            ...
            for (var i = 0; i < itemsCount; i++) {
                itemEntity = afw.uiApi.CreateNewEntity("wm.StuffStatusChangeAndTransferItem");
                itemEntity.SetFieldValue("StuffStatusChangeAndTransfer",
                    that.StuffStatusChangeAndTransferEditForm.GetBindableEntity().get("ID"));
        ...
        AddRow: function (rowEntity) {
            ...
            var rowControl = new wm.StuffStatusChangeAndTransferItemsGridRowControl({
        ...
        GetStuffRealStock: function () {
            ...
            for (var i = 0; i < that.GetRowsCount() ; i++) {
                that.GetRowByIndex(i).GetStuffRealStock();
            }
        },
    ...
    FormClass.TypeName = "wm.StuffStatusChangeAndTransferItemsGridControl";
    FormClass.BaseType = afw.BasePanel;


    wm.StuffStatusChangeAndTransferItemsGridControl = FormClass;
})();